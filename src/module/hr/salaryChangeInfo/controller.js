...
define(function (require) {
    ...
    app.controller('hrSalaryChangeInfoCtrl', ['$scope', 'hrRequest', '$stateParams', 'localStorage', '$state', '$sce',
        function ($scope, hrRequest, $stateParams, localStorage, $state, $sce) {
            ...
            $scope.getChangeList = function () {
                hrRequest.getStaffSalaryChangeInfo({
                    number: $scope.number
                }).then(function (res) {
